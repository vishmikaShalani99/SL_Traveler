<?php include('partials/menu.php'); ?>
          ...
          <div class="main-content">
                <div class="wrapper">
                    <h2>Update Guide</h2><br><br>

                    <?php

                        if(isset($_GET['id'])){
                            $id = $_GET['id'];
                            $sql = "SELECT *FROM tbl_guide WHERE id=$id";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <table class ="tbl-30">
                            <tr>
                            <td>Name:</td> 
                            <td><input type="text" name="guide_name" value="<?php echo $guide_name?>"></td> 
                            </tr>
                            ...
                            <input type="submit" name="submit" value="Update Guide" class="btn-secondary"></td> 
